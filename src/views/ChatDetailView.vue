...
const messages = ref([
  ...
  {
    id: 2,
    text: '¡Hola Dulfary! Déjame revisar mi agenda un momento 💅',
    isMe: false,
    time: '10:32 AM',
  },
  {
    id: 3,
    text: 'Sí, tengo un espacio libre a las 3:00 PM. ¿Te sirve?',
    isMe: false,
    time: '10:33 AM',
  },
  {
    id: 4,
    text: 'Perfecto, resérvame ese espacio por favor.',
    isMe: true,
    time: '10:35 AM',
    read: true,
  },
...
<template>
  <div class="h-screen relative bg-chat-pattern font-sans">
      ...
      >
        ...
        <div class="flex items-center gap-1 mt-1 px-1">
          ...
          <i
            ...
            :class="msg.read ? 'text-pink-500' : 'text-gray-300'"
          ></i>
        </div>
      </div>
    </main>
    ...
    <footer
      class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md p-3 px-4 border-t border-gray-100 z-30 max-w-md mx-auto"
    >
      <div
      ...
      >
        <button
          class="text-gray-400 hover:text-pink-500 transition p-2 flex items-center justify-center"
        >
